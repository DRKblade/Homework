...
namespace _1712400_BT1
{
    class ShapeConstruction		// Lớp các thuật toán vẽ hình
    {
        ...
        public void ConstructCircle(Shape shape, Point pStart, Point pEnd)
        {
            ...
            shape.ControlPoint.Add(temp); // Điểm thứ 1.


            temp.X = pCenter.X;
            temp.Y = pCenter.Y + Convert.ToInt32(r);
            shape.ControlPoint.Add(temp); // Điểm thứ 2.

            temp.X = pCenter.X + Convert.ToInt32(r);
            temp.Y = pCenter.Y + Convert.ToInt32(r);
            shape.ControlPoint.Add(temp); // Điểm thứ 3.

            temp.X = pCenter.X - Convert.ToInt32(r);
            temp.Y = pCenter.Y;
            shape.ControlPoint.Add(temp); // Điểm thứ 4.

            temp.X = pCenter.X + Convert.ToInt32(r);
            temp.Y = pCenter.Y;
            shape.ControlPoint.Add(temp); // Điểm thứ 5

            temp.X = pCenter.X - Convert.ToInt32(r);
            temp.Y = pCenter.Y - Convert.ToInt32(r);
            shape.ControlPoint.Add(temp); // Điểm thứ 6.

            temp.X = pCenter.X;
            temp.Y = pCenter.Y - Convert.ToInt32(r);
            shape.ControlPoint.Add(temp); // Điểm thứ 7.

            temp.X = pCenter.X + Convert.ToInt32(r);
            temp.Y = pCenter.Y - Convert.ToInt32(r);
            shape.ControlPoint.Add(temp); // Điểm thứ 8.
        ...
        public void ConstructEllipse(Shape shape, Point pStart, Point pEnd)
        {
            ...
            //Control Point. có tất cả 8 điểm.
            shape.ControlPoint.Clear();
            shape.ControlPoint.Add(pStart); // Điểm thứ 1.
            ...
            shape.ControlPoint.Add(pEnd); // Điểm thứ 8.
        ...
        {
            Point center = new Point(0, 0); // luc deu luon noi tiep duong tron va dinh luon cach nhau 60
